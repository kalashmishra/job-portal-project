...
import { asynceditaccompstudent } from "@/store/Actions/studentActions";
...
//   console.log(student.resume.accomp  )
    const int=student.resume.accomplishments[0]
  ...
  const EditAccompHandler = (e) => {
    ...
    dispatch(asynceditaccompstudent(params.id, accomp));
...
<div className="signinform m-0">
    <div className="item-container">
        <h2 className="log-in">Edit Accomplishment</h2>
    </div>
    ...
    <div className="form-input">
           ...
           <div>
            <button  type="submit"> Edit Accomplishment</button>
        </div>
    </form>
     </div>
</div>
